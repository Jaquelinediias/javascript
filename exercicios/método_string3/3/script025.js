...
//toLocaleUpperCase()Função para deixa toda a frase maiúscula .


//replace('Dias','Perreira') // substitui texto ou nomes dentro de um string .Recebe dois parâmentros x, y.
